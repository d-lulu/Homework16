...
/**
 * Заполнение массива случаными вещественными числами от -1 до 1
 * @param ptr_array указатель на массив
 * @param n размер массива
 * @return указатель на заполненный массив
 */
double* full_elements_1(double* ptr_array, int n);

/**
 * Заполнение массива array_a, array_b или array_с случайными вещественными числами
 * @param ptr_array указатель на массив
 * @param n размер массива
 * @param type тип (номер) массива
 * @return указатель на заполненный массив
 */
